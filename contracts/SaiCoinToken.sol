/*
  ...
  Copyright 2017 SaiCoin Foundation.
...
/// @title SaiCoin Protocol Token.
/// For more information about this token sale, please visit https://SaiCoin.org
/// @author Kongliang Zhong - <kongliang@SaiCoin.org>, Daniel Wang - <daniel@SaiCoin.org>.
contract SaiCoinToken is StandardToken {
    string public constant NAME = "SaiCoin";
    string public constant SYMBOL = "SCO";
    uint public constant DECIMALS = 18;

    bool public _saleStart = false;
    ...
    /// Each phase contains exactly 10 Ethereum blocks, which is roughly 3 days,
    ...
    uint256 public constant GOAL = 5 ether;

    /// Maximum amount of fund to be raised, the sale ends on reaching this amount.
    uint256 public constant HARD_CAP = 12 ether;
    ...
    /// Base exchange rate is set to 1 ETH = 5000 SCO.
     ...
     * CONSTRUCTOR
     *
     * @dev Initialize the SaiCoin Token
     ...
     */
    function SaiCoinToken(address _target) {
        target = _target;
    }
    ...
    /// @dev Start the token sale.
    /// @param _firstblock The block from which the sale will start.
    function end(uint _firstblock) public onlyOwner beforeStart {
        _saleEnd = true;
    }
